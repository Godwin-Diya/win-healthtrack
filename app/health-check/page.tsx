...
export default function HealthCheckPage() {
    ...
    function checkResult() {
        ...
        setResult("⚠️ Please enter your age, blood glucose level and select whether the reading was taken while fasting.");
        ...
        if (isFasting === "yes") {
            ...
            if (glucoseNumber < 70) {
                ...
                explanationMessage = "Your blood glucose reading is below the expected range.";
                ...
                explanationMessage = "Your blood glucose reading is within the expected non-fasting range.";
                ...
                explanationMessage = "Your blood glucose reading is above the expected non-fasting range.";

                adviceMessage = "Consider monitoring your blood glucose regularly and discussing persistent high readings with a healthcare professional.";
